...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE
        """
        Note: While the instructions above ask to initailize b1 and b2 to zero, doing so gives incorrect
        results. Instead b1 and b2 are initialized using a uniform random distribution. (ref:
        https://github.com/hankcs/CS224n/blob/master/assignment2/q2_parser_model.py)
        """
    ...
    def run_epoch(self, sess, parser, train_examples, dev_set):
        ...
        for i, (train_x, train_y) in enumerate(minibatches(train_examples, self.config.batch_size)):
            ...
            """
            The force argument in tf.keras.utils.Progbar.update is DEPRECATED. So using the default
            statement raises error at runtime. Hence, the force argument is removed.
            """
